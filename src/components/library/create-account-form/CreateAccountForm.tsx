...
const createAccount = (email: string, password: string) => {
  "Add this function to api/user";
};

export const CreateAccountForm = ({ redirectLink = "/login", buttonLink }: any) => {
  ...
  const confirmPassword = useCallback(({ value }: any) => value === formData.current.password, []);
