...
const activityMenuItems = [{ text: "View details" }, { text: "Delete" }];
...
const ActivitiesList = ({ activities }: any) => {
  return <List className="activities-list" dataSource={activities} scrollingEnabled={false} itemRender={listItemRender} />;
};
