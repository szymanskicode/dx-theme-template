...
export const ChangeProfilePasswordForm = ({ visible, setVisible }: any) => {
  ...
  useEffect(() => {
    ...
    setIsSaveDisabled(formValues.some((value) => !value) || validity.some((value) => !value));
  }, [currentPassword, newPassword, confirmedPassword, currentPasswordValid, newPasswordValid, confirmedPasswordValid]);
  ...
  return (
    ...
    >
      <Form id="form" labelMode="outside" showColonAfterLabel labelLocation="top">
        <Item>
          <Label text="Current Password" />
          <PasswordTextBox value={currentPassword} placeholder="Current Password" onValueChange={setCurrentPassword} onValueValidated={onCurrentPasswordValidated} />
        </Item>
        ...
        <Item>
          <Label text="Password" />
          <PasswordTextBox value={newPassword} placeholder="Password" onValueChange={onNewPasswordChange} onValueValidated={onNewPasswordValidated} />
        </Item>
