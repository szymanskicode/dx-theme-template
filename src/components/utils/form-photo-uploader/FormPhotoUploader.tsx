...
export const FormPhotoUploader = () => {
  ...
  const getUploaderRef = useCallback((element: any) => {
  ...
  return (
    <div>
      <div ref={getUploaderRef} id="uploader" className={`${isDropZoneActive ? "dx-theme-accent-as-border-color" : "dx-theme-border-color"}`}>
